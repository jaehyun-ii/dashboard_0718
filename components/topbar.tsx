...
export function Topbar() {
  const { sidebarOpen, setSidebarOpen } = useDashboardStore() // Removed selectedDateRange, navigateDate

  return (
    <div className="bg-gradient-to-r from-slate-50 to-blue-50 border-b border-slate-200 p-4 flex items-center justify-between shadow-sm">
      ...
      <div className="flex items-center gap-6">
        <button className="p-3 hover:bg-white/80 rounded-xl transition-all duration-200 relative" aria-label="알림">
        ...
        <div className="flex items-center gap-3 px-4 py-2 bg-white rounded-xl shadow-sm border border-slate-200">
          <span className="text-sm font-medium text-slate-700 hidden sm:block">관리자</span>
